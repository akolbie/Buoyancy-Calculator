...
class Vessel():
    ...
    """
    def __init__(self, mass, volume, COG, COB, height):
...
class SideWall(Vessel):
    ...
    """
    def __init__(self, mass, volume, COG, COB, height):
        super().__init__(mass, volume, COG, COB, height)
...
def import_vessels(location):
    """
    Returns a list of vessel objects
    """
    pass

def import_heights(location):
    """
    Returns a list of list of heights of corresponding vessels
    """
    pass

def import_vehicle_data(location):
    """
    Returns a dictionary of vehicle data
    """
    pass
...
if __name__ == '__main__':
    vessels = import_vessels('vessels.csv')
    heights = import_heights('heights.csv')
    vehicle_data = import_vehicle_data('vehicle_data.csv')
